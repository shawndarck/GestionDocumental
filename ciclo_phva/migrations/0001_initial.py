# Generated by Django 4.0.4 on 2022-05-24 20:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_item_estandar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ciclo_phva.itemestandar')),
                ('permisos_usuarios', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
            ],
            options={
