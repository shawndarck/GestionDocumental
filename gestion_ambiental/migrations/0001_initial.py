# Generated by Django 4.0.4 on 2022-06-24 13:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_gestion_ambiental', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='item_estandar', to='gestion_ambiental.politicagestionambiental')),
            ],
            options={
